...
int main(int argc, char **argv)
{
    ...
    // Eigen::Affine3f::Identity()返回一个4*4的单位矩阵，scene_sensor_pose也是4*4单位矩阵
    ...
    { // keypoints[i].getVector3fMap() 返回的似乎是个xyz坐标，浮点数表示。
        keypoints[i].getVector3fMap() = range_image[keypoint_indices[i]].getVector3fMap();

        // std::cout << keypoints[i].getVector3fMap() << std::endl;
    }
